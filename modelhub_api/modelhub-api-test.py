...
datasets = qr.get_datasets_info(csv_dir=csv_dir, n=5,
                                method_ids=['classify_svm', 'classify_knn'])
print '\t+{}+'.format('-'*41)
...
classifier_ids = qr.get_classifier_ids(csv_dir=csv_dir, n=5, dataset_ids=2,
                                       method_ids=['classify_svm',
                                                   'classify_knn'])
classifier_structs = qr.get_classifier_details(csv_dir=csv_dir,
...
for classifier_struct in classifier_structs:
    print '\t| {0: >15} | {1:9.2f} |'.format(classifier_struct.classifier_id,
                                             classifier_struct.test_metric)
print '\t|{}|'.format('-' * 29)
